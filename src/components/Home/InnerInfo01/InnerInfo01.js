...
const InnerInfo01 = () => {
    return (
        <div className="bg-white inner-info-one py-16">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-12 items-center">
                <div>
                    <h2 className="capitalize text-5xl font-semibold mb-6">Improving The Quility Of Your life through better health</h2>
                    ...
                    <Link to="/#doctors"><button className="capitalize py-4 px-8 bg-lightGreen rounded-full text-black font-semibold text-lg mt-6">Meet our doctors</button></Link>
                </div>
                <div>
                    <img src={info} alt="" />
                </div>
